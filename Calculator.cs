namespace FirstCourseTask
{
    ...
    {
        public double ReturnNormalizedNumber(string number)
        {
        ...
        public double? Result(double firstNumber, double secondNumber, string operation)
        {
            switch (operation)
            {
                case "1":
